...
const (
	GreetingService_Hello_FullMethodName             = "/greeting.GreetingService/Hello"
	GreetingService_HelloServerStream_FullMethodName = "/greeting.GreetingService/HelloServerStream"
)
